...
//	send_data[2][7] = (unsigned short int)(0);
	...
	send_data[0][0] = (unsigned short int)(Speed_goal1);//mpu6050_Acc_x_ave);
	send_data[0][1] = (unsigned short int)(0);//mpu6050_Gyro_x_ave);
//	send_data[0][2] = (unsigned short int)(0);
//	send_data[0][3] = (unsigned short int)(0);
//
	send_data[1][0] = (unsigned short int)(Speed_goal2);//mpu6050_Acc_y_ave);
//	send_data[1][1] = (unsigned short int)(0);//mpu6050_Gyro_y_ave);
//	send_data[1][2] = (unsigned short int)(0);
//	send_data[1][3] = (unsigned short int)(0);
//
	send_data[2][0] = (unsigned short int)(0);//mpu6050_Acc_z_ave);
//	send_data[2][1] = (unsigned short int)(0);//mpu6050_Gyro_z_ave);
//	send_data[2][2] = (unsigned short int)(0);
//	send_data[2][3] = (unsigned short int)(0);
...
/*************************************************************************
*  函数名称：void bluetooth(u8 line1,u8 line2,u8 line3,u8* key,u8* x1,u8* x2,u8* x3)
*  参数说明：			    曲线1	 曲线2	  曲线3	  开关变量	调参1 调参2  调参3
*  功能说明：蓝牙数据曲线、调参
*  函数返回：无
*  修改时间：2018-4-5    
*************************************************************************/ 
//void bluetooth(u8 line1,u8 line2,u8 line3,u8* key,u8* x1,u8* x2,u8* x3)
//{
//  static u8 RX=0;
//
//  if(uart_query(UART1))
//  {
//    RX=uart_getchar(UART1);
//    if(RX==0)
//      uart_putchar (UART1,line1);
//    else if(RX==1)
//      uart_putchar (UART1,line2);
//    else if(RX==2)
//      uart_putchar (UART1,line3);
//    else if(RX==3)
//    {if(*x1!=255)     *x1+=1;uart_putchar (UART1,*x1);}
//    else if(RX==4)
//    {if(*x1!=0)       *x1-=1;uart_putchar (UART1,*x1);}
//    else if(RX==5)
//    {if(*x2!=255)     *x2+=1;uart_putchar (UART1,*x2);}
//    else if(RX==6)
//    {if(*x2!=0)       *x2-=1;uart_putchar (UART1,*x2);}
//    else if(RX==7)
//    {if(*x3!=255)     *x3+=1;uart_putchar (UART1,*x3);}
//    else if(RX==8)
//    {if(*x3!=0)       *x3-=1;uart_putchar (UART1,*x3);}
//    
//    else if(RX==254)
//    {*key=1;uart_putchar (UART1,*key);}
//    else if(RX==255)
//    {*key=0;uart_putchar (UART1,*key);}
//  }
//
//}
